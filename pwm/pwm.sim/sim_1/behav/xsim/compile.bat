...
REM
REM Generated by Vivado on Tue Apr 28 18:10:24 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_pwm_top_vhdl.prj"
call xvhdl  --incr --relax -prj tb_pwm_top_vhdl.prj -log xvhdl.log
