...
REM
REM Generated by Vivado on Wed Apr 22 11:55:58 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_clk_en_wave_vhdl.prj"
call xvhdl  --incr --relax -prj tb_clk_en_wave_vhdl.prj -log xvhdl.log
