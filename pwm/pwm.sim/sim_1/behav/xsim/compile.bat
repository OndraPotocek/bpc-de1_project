...
REM
REM Generated by Vivado on Thu Apr 23 08:36:51 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_counter_1bit_vhdl.prj"
call xvhdl  --incr --relax -prj tb_counter_1bit_vhdl.prj -log xvhdl.log
