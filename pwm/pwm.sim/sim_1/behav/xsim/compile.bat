...
REM
REM Generated by Vivado on Thu Apr 23 08:08:32 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_flip_flop_vhdl.prj"
call xvhdl  --incr --relax -prj tb_flip_flop_vhdl.prj -log xvhdl.log
