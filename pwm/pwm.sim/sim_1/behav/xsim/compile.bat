...
REM
REM Generated by Vivado on Thu Apr 16 09:32:16 +0200 2026
...
echo "xvhdl --incr --relax -prj pwm_mux_vhdl.prj"
call xvhdl  --incr --relax -prj pwm_mux_vhdl.prj -log xvhdl.log
