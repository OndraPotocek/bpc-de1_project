...
entity pwm_top is
    Port(clk      : in STD_LOGIC; 
         ...
         dp       : out STD_LOGIC;                 -- Added semicolon here
         oscilloscope : out STD_LOGIC              -- ADDED THIS LINE!
    );
end entity pwm_top;
...
architecture Behavioral of pwm_top is
    ...
    signal sig_pwm_mux   : STD_LOGIC_VECTOR(7 downto 0);
    
    signal sig_enwave    : STD_LOGIC; -- FIXED: Renamed to avoid component collision
    ...
    component clk_en_wave
        Port(clk        : in STD_LOGIC;
             rst        : in STD_LOGIC;
             sel_period : in STD_LOGIC_VECTOR(3 downto 0); -- FIXED: 4 bits
             ce         : out STD_LOGIC
        );
    end component;
...
component flip_flop
    ...
    component disp_mux
        Port(sig_dig : in STD_LOGIC;
             sw0     : in STD_LOGIC_VECTOR(3 downto 0); -- FIXED: 4 bits
             sw1     : in STD_LOGIC_VECTOR(1 downto 0); -- FIXED: 2 bits
             bin     : out STD_LOGIC_VECTOR(3 downto 0) -- FIXED: Renamed to "bin"
        );
    end component;
...
begin
    ...
    clk_en_wave_inst : clk_en_wave
        port map(
            clk        => clk,
            rst        => rst_btnc,
            sel_period => sw(3 downto 0), -- FIXED
            ce         => sig_enwave      -- FIXED
        );
    ...
    -- Oscilloscope output (Duplicate the PWM signal to the Pmod header)
    oscilloscope <= pwm_out_sig; -- ADDED THIS LINE!
    ...
    disp_mux_inst : disp_mux
        port map(
            sig_dig => sig_digit,
            sw0     => sw(3 downto 0), -- First 4 switches for Pitch
            sw1     => sw(6 downto 5), -- Last 2 switches for Duty Cycle
            bin     => sig_bin         -- Output mapped to internal sig_bin wire
        );
