...
REM
REM Generated by Vivado on Thu Apr 16 08:56:53 +0200 2026
...
echo "xvhdl --incr --relax -prj display_driver_vhdl.prj"
call xvhdl  --incr --relax -prj display_driver_vhdl.prj -log xvhdl.log
